...
#define AC_DISPLAY_PLAYING_UPDATE_INTERVAL (50)
#define AC_DISPLAY_SETTITNG_ANIMCATION_UPDATE_INTERVAL (200)
    ...
    enum
    {
        ...
        AC_DISPLAY_BUTON_MODE_RELEASE,
        AC_DISPLAY_BUTON_MODE_LONG_PRESS,
...
enum
{
    EVENT_TINY_REX_SETUP = TINY_REX_DEFINE_SIG,
    EVENT_TINY_REX_PLAY,
    EVENT_TINY_REX_UPDATE,

    EVENT_BUTTON_UP_PRESS,
    EVENT_BUTTON_DOWN_PRESS,
    EVENT_BUTTON_MODE_PRESS,
    EVENT_BUTTON_MODE_RELEASE,
};
